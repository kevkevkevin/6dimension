            ...
            <div className={`offcanvas__area ${sidebarOpen ? "offcanvas-opened" : ""} ${home_three ? "home-3-pos" : ""}`}>
                ...
                <div className="offcanvas__content">
                    ...
                    <div className="offcanvas__popup">
                        <p>At Dimensions Software Company, we understand that technology is constantly changing, and we strive to stay up-to-date with the latest trends and developments in the industry.</p>
                    ...
                    <div className="offcanvas__contact">
                        ...
                        <div className="offcanvas__contact-content d-flex">
                            ...
                            <a href="https://www.google.com/maps/place/Mansour+Holding+Group/@21.5487031,39.134019,19.79z/data=!4m9!1m2!2m1!1sgym+near+me+!3m5!1s0x15c3c5758ae231dd:0x7a1bb4851e31878b!8m2!3d21.5487071!4d39.1340835!16s%2Fg%2F11khjgtwbf?entry=ttu">2916 Mohammad Mlibari Street Al khaladiyah Dist. Unit No: 6270 </a>
                            </div>
                        </div>
                        <div className="offcanvas__contact-content d-flex">
                            <div className="offcanvas__contact-content-icon">
                            ...
                            <div className="offcanvas__contact-content-content">
                            <a href="mailto:needhelp@company.com">info@6dimension.sa  </a>
                            </div>
                        </div>
                        <div className="offcanvas__contact-content d-flex">
                            <div className="offcanvas__contact-content-icon">
                    ...
                    <div className="offcanvas__social"> 
                        ...
                        <a className="icon instagram" href="#"><i className="fab fa-instagram"></i></a>
