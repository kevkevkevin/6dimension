...
import brand_img_9 from "@assets/img/brand/home-3/brand-9.png";
import brand_img_10 from "@assets/img/brand/home-3/brand-10.png";
import brand_img_0 from "@assets/img/brand/home-3/brand-0.png";

const brand_img = [brand_img_1, brand_img_2, brand_img_3, brand_img_4, brand_img_5, brand_img_6, brand_img_7, brand_img_8, brand_img_9, brand_img_10, brand_img_0]
                                    ...
                                    {brand_img.map((item, i) => 
                                        <SwiperSlide key={i}>
                                            <div className="tp-brand-3-thumb">
                                                <Image src={item} alt="theme-pure" width={'200'} height={'200'}/>
                                            </div>
                                        </SwiperSlide>
                                    )} 
                                </Swiper>
