...
import Logo from "@assets/img/logo/6dimensions.png";
                              ...
                              <ul>
                                 <li>
                                    ...
                                    target="_blank"><span>
                                       ...
                                       </span>Mohamad Malibrai 2916, Jeddah 23421, Saudi Arabia</a>
                                 </li>
                                 <li>
                                    <a href="mailto:technix@support.com"><span>
                                       <i className="fa-solid fa-envelope"></i></span>info@6dimensions.sa
                                    </a>
                                 </li>
                                 <li>
                        ...
                        <div className="col-xxl-6 col-xl-4">
                           <div className="tp-header-top-right d-flex justify-content-end align-items-center">
                              <div className="header-call">
                                 <a href="tel:+966920002393"><i className="fa-solid fa-phone"></i> +966 920 002 393</a>
                              </div>
