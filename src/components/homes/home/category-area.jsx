                    ...
                    <div className="col-xl-5 col-lg-5 col-md-6">
                        <div className="tp-category-content-wrapper d-flex">
                            ...
                            <div className="tp-category-icon">
                                ...
                                <h4 className="tp-category-content-title">Consultation</h4>
                            </div>
                            </div>
                    ...
                    <div className="col-xl-2 col-lg-2 col-md-4 order-3 order-md-2">
                        <div className="tp-category-content-wrapper d-flex">
                            ...
                            <div className="tp-category-icon">
                                ...
                                <h4 className="tp-category-content-title">Low Current <br /> Solution</h4>
                            </div>
                            </div>
                        </div>
                    </div>
                    <div className="col-xl-5 col-lg-5 col-md-12 order-2 order-md-3">
                        <div className="tp-category-content-wrapper d-flex">
                            ...
                            <div className="tp-category-icon">
                                ...
                                <h4 className="tp-category-content-title">Tailored <br /> IT Solutions</h4>
                            </div>
                            </div>
                        </div>
                    </div>
